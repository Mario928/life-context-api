...
An open-source pipeline for continuous audio lifelogging that lets you capture, process, and query your spoken life. Record audio continuously, transcribe it automatically, and extract behavioral insights, all with your own controlled infrastructure and complete data ownership.
